...
use App\Filament\Resources\VirementBudgetaireResource\Pages;
...
class VirementBudgetaireResource extends Resource
{
    ...
    /**
     * Permissions - Virements budgétaires
     */
    ...
    /**
     * Action spéciale : Exécuter un virement
     */
    ...
    /**
     * Action spéciale : Annuler un virement
     */
                    ...
                    ->schema([
                        ...
                        Forms\Components\Select::make('ligne_source_id')
                            ...
                            ->helperText(function (callable $get) {
                                ...
                                if (!$ligneId) {
                                    return 'Ligne qui va céder du budget';
                                }
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('executer')
                    ...
                    ->modalDescription(fn($record) => "Exécuter le virement de " . number_format($record->montant, 0, ',', ' ') . " FCFA ? Cette action est irréversible.")
                    ->action(function ($record) {
                        try {
                            $record->executer();
                            Notification::make()

...
class MesTachesEnAttenteWidget extends BaseWidget
{
    ...
    protected function getDocumentUrl(Transmission $transmission): string
    {
        return match ($transmission->document_type) {
            'App\Models\BonCommande' => route('filament.budget.resources.bon-commandes.view', $transmission->document_id),
            'App\Models\Engagement' => route('filament.budget.resources.engagements.view', $transmission->document_id),

...
@section('content')
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 5px;">
        <tr>
            <td style="border: none; padding: 0; vertical-align: top; width: 65%;">
                ...
                {{-- ✅ Détail des montants avec TOUS les impôts --}}
                @if ($bonCommande && $detailImpots)
                    <div style="margin-top: 8px; font-size: 8.5pt;">
                        ...
                        <table class="detail-montants">
                            <tr>
                                <td class="label">Montant Hors Taxe (HT)</td>
                                <td class="montant">{{ number_format($montantHT, 0, ',', ' ') }} FCFA</td>
                            </tr>
                            <tr>
                                <td class="label">TVA (19.25%)</td>
                                <td class="montant">{{ number_format($montantTVA, 0, ',', ' ') }} FCFA</td>
                            </tr>
                            <tr class="total-row">
                                <td class="label">Montant Total Brut (TTC)</td>
                                <td class="montant">{{ number_format($montantBrut, 0, ',', ' ') }} FCFA</td>
                            </tr>
                            <tr>
    ...
    @endsection@extends('pdf.layouts.master', ['typeHeader' => 'op', 'typeFooter' => 'op'])
                ...
                @if ($bonCommande && $detailImpots)
                    <div style="margin-top: 8px; font-size: 8.5pt;">
                        ...
                        <table class="detail-montants">
                            ...
                            <tr>
                                <td colspan="2"
                                    style="padding: 4px 5px; font-weight: bold; background-color: #fff3e0;">A PRECOMPTER
                                    (Impots et Taxes):</td>
                            </tr>
                            @if ($detailImpots['tva'] > 0)
                                <tr>
                            ...
                            @if ($detailImpots['autres'] > 0)
                                <tr>
                                    <td class="label" style="padding-left: 15px;">• Autres taxes</td>
                                    <td class="montant">{{ number_format($detailImpots['autres'], 0, ',', ' ') }} FCFA
                                    </td>
                                </tr>
                            @endif
                            <tr style="background-color: #fff3e0; font-weight: bold;">

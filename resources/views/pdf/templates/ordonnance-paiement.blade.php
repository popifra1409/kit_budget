...
@php
    ...
    $nomBeneficiaire = $beneficiaire->raison_sociale ?? ($beneficiaire->name ?? 'PEC MEDICAL');
@endphp
        ...
        <tr>
            <td style="border: none; padding: 0; vertical-align: top; width: 65%;">
                <div style="font-size: 8.5pt; line-height: 1.1; margin-bottom: 2px;">
                    ...
                    <div style="padding-left: 3px;">{{ $ordonnance->objet ?? 'ACHAT DES CONSOMMABLES MEDICAUX' }}</div>
                ...
                <div style="font-weight: bold; font-size: 10pt; line-height: 1.2; margin-top: 4px;">
                    Paiement selon le bon <span
                        style="font-size: 11pt;">{{ $bonCommande->numero ?? ($engagement->numero ?? 'BE25-1261') }}</span>
                </div>
            </td>

...
// ✅ Code sous-programme — chiffre entre parenthèses ex: (4)
if ($sousProgramme) {
$codeSousProgrammeBrut = $sousProgramme->code ?? '';
$chiffres = preg_replace('/[^0-9]/', '', $codeSousProgrammeBrut);
$codeSousProgramme = $chiffres !== '' ? '(' . (int)$chiffres . ')' : $codeSousProgrammeBrut;
}
...
$codeProgramme = $chiffresProg !== '' ? '(' . (int)$chiffresProg . ')' : $codeProgrammeBrut;
}
    ...
    <tr>
        ...
        <td style="width:30%; vertical-align:top; padding:5px;" class="border-right">
            ...
            <div style="margin-top: 5px; font-size: 8pt;">
                ...
                <div>• <span class="font-bold" style="font-size: 8pt;">PROGRAMME :
                    </span>{{ $codeProgramme }} - {{ $programme->libelle ?? '' }}</div>
                @endif
        ...
        <td style="width:30%; vertical-align:top; padding:5px;">
            ...
            <div style="margin-top: 3px;">
                <div style="font-size: 8pt;">En vertu des crédits ouverts au titre de l'imputation
                    ...
                    {{ strtoupper($parametres->sigle) }}, le paiment de la créance de détailée ci-dessus.
                </div>
